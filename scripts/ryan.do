...
add wave -noupdate /tb_usb_ahb_soc/DUT/RXBLOCK/timer/en_sample
add wave -noupdate /tb_usb_ahb_soc/DUT/RXBLOCK/timer/count8
add wave -noupdate /tb_usb_ahb_soc/DUT/RXBLOCK/timer/count_reset
add wave -noupdate /tb_usb_ahb_soc/DUT/RXBLOCK/timer/ignore_count
add wave -noupdate /tb_usb_ahb_soc/DUT/RXBLOCK/timer/state
...
WaveRestoreCursors {{Cursor 1} {3045000 ps} 0}
