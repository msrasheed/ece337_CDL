...
add wave -noupdate /tb_protocol_controller/DUT/PS
add wave -noupdate /tb_protocol_controller/tb_rx_packet
...
WaveRestoreCursors {{Cursor 1} {48521 ps} 0}
...
update
WaveRestoreZoom {19678 ps} {146120 ps}
