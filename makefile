...
COMPONENT_FILES	:= ahb_addr_dec.sv encoder.sv RX_timer.sv ahb_slave_cntrlr.sv flex_counter.sv ahb_slave.sv flex_pts_sr.sv bit_stuffer.sv flex_stp_sr.sv clr_trans_size_fsm.sv protocol_controller.sv counter25.sv pts_8_bit.sv counter.sv RX_bit_stuff_detector.sv tx_fsm.sv crc_16bit_chk.sv RX_byte_counter.sv tx_timer.sv crc_16_bit_gen.sv RX_ControlFSM.sv crc_5bit_chk.sv RX_decoder.sv USB_RX.sv data_buffer.sv RX_SR.sv usb_tx.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= usb_ahb_soc.sv
